...
import com.hn.linzi.activity.Personal_Settings;
...
public class UpdataAPK extends Service {
	private static final int NOTIFY_ID = 0;
	private int progress;
	private NotificationManager mNotificationManager;
	private boolean canceled;
	/* 下载包安装路径 */
	private static final String savePath =  Environment.getExternalStorageDirectory().getAbsolutePath() + "/FZYDDL/apk/";

	private static final String saveFileName = savePath + "智泉阅读.apk";
...
//					contentview.setProgressBar(R.id.progressbar, 100, rate, false);
					...
					Intent intent = new Intent(mContext, Personal_Settings.class);
					// 告知已完成
...
//			UpdataAPK.this.callback = callback;
//		}
	}
